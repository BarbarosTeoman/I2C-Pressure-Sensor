...
static void ClockSetup(void)
{
	...
	(void)CyIntSetVector(14u, &CySysTimerIsr);
	CyIntEnable(14u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_PASS0_DSAB_DSAB_CTRL, 0x00000020u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM1_DFT_CTRL, 0x00000003u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_PASS1_DSAB_DSAB_CTRL, 0x00000020u);
...
{
	uint32 regValue = CY_GET_XTND_REG32((void *)(CYREG_SAR0_PUMP_CTRL));
	if (enabled != 0u)
	{
	...
	CY_SET_XTND_REG32((void *)(CYREG_SAR0_PUMP_CTRL), regValue);

	regValue = CY_GET_XTND_REG32((void *)(CYREG_SAR1_PUMP_CTRL));
	if (enabled != 0u)
	{
		regValue |= 0x80000000u;
	}
	...
	CY_SET_XTND_REG32((void *)(CYREG_SAR1_PUMP_CTRL), regValue);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00180024u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC2), 0x00000006u);
